...
class KartukuDirectAPI {
    ...
    // ipgUrl    
    const IPG_DIRECT_BASE_URL_STAGING    = "https://ipg-dev.kartuku.com/";
    ...
    private function getTransactionUrl($command){
        return (self::$production ? self::IPG_DIRECT_BASE_URL_PRODUCTION : self::IPG_DIRECT_BASE_URL_STAGING) . "direct/" . $command;
    }
    
    private function getTokenUrl($command){
        return (self::$production ? self::IPG_DIRECT_BASE_URL_PRODUCTION : self::IPG_DIRECT_BASE_URL_STAGING) . "card/token/" . $command;
    }
    ...
    public static function getIPGUrl(){
        return self::$production ? self::IPG_DIRECT_BASE_URL_PRODUCTION : self::IPG_DIRECT_BASE_URL_STAGING;
    }
